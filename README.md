...
ЛР 4: Я бы хотел взять проект про eDSL для конечных автоматов (а именно, связанное с лифтом), так как это идеальная задача для OCaml. Алгебраические типы данных подходят для моделирования состояний и переходов. С помощью модульной системы можно создать красивый DSL с понятным синтаксисом. Плюс OCaml отлично генерирует DOT. 
